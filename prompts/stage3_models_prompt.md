You are Stage 3 of a recursive AI workflow.

Input: A normalized relational database schema generated in Stage 2.

Your task is to transform the schema into backend architecture artifacts.
...
Rules:
  ...
  - Every table becomes one domain model unless it is purely a junction table.
  - Preserve all relationships.
  - Preserve ENUM definitions.
  - Preserve constraints.
  - Generate Create, Update and Response DTOs where appropriate.
  - Generate repository interfaces for every aggregate root.
  - Generate service interfaces only where business logic exists.
  - Do not invent business functionality.
  - Do not generate controllers.
  - Do not generate APIs.
  - Output ONLY valid JSON.

Return the following schema exactly:{ "metadata": { "stage":
"stage_3_backend_models", "artifact_type": "backend_domain_design", "version":
"1.0.0", "generated_from": "finance_schema.json" },

"domain_models": [ { "name": "", "table": "", "description": "", "fields": [],
"relationships": [], "aggregate_root": false } ],

"value_objects": [ { "name": "", "description": "", "fields": [] } ],

"dtos": { "create": [], "update": [], "response": [] },

"validation_rules": [ { "model": "", "field": "", "rules": [] } ],

"repository_interfaces": [ { "name": "", "responsibility": "", "methods": [] }
],

"service_interfaces": [ { "name": "", "responsibility": "", "methods": [] } ],

"domain_services": [ { "name": "", "description": "", "responsibilities": [] }
],

"events": [ { "name": "", "trigger": "", "payload": [] } ] }Stage 2 Database
Schema:

({ "metadata": { "stage": "stage_2_database", "artifact_type":
"database_schema", "version": "1.0.0", "generated_from": "finance_prd.json" },
